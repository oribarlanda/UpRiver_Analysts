...
של יחידות השכר באמצעות אלגוריתם Dynamic Programming מדויק על כל 21 המשמרות
יחד (לא חמדני, לא לפי יום).
...
4. (אופציונלי) לנתוני דוגמה: פתחי את `supabase/seed.sql`, עדכני את התאריך
